...
$().ready(function() {
 $("#editForm").validate();
  ...
  <body>
    <form action = "/BookSystem/bookcase/save.do" method="post" id="editForm">
    	<table border="1px" style="text-align:center;">
    		<input type ="hidden" name = "id" id="id" value="${bookCase.id }"/>
    		<tr>
    			<td style="width:100px">架名</td>
    			<td><input type="text" name ="name" id ="typeName" value ="${bookCase.name }" class="{required:true,minlength:5}"/></td>
    		</tr>
    		<tr>
    			<td>备注</td>
    			<td><input type="text" name ="comment" id ="comment" value="${bookCase.comment }" class="{required:true,minlength:5}"/></td>
    		</tr>
    	</table>
    </form>
  </body>
