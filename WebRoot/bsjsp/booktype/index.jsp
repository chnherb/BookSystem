...
function deletedata(id){
	var action = "/BookSystem/booktype/delete.do";
	params = "id="+id;
...
$(function(){
 ...
 //修改
function toSave(id) {
	var url = "/BookSystem/booktype/add.do";
	if(id!=''){
		url = "/BookSystem/booktype/add.do?id="+id;
	}
	seajs.config({
		  alias: {
 ...
 <div id="main">
  <div class="mainleft">
   <ul>
    ...
    <li><a href="/BookSystem/booktype/list.do" class="hover">书籍类别</a></li>
  ...
  <div class="mainright">
   <div class="content">
   	<div style="margin-top:15px; text-align:center;">
   		<form action="/BookSystem/booktype/list.do" method="post" id ="queryform">
