 ...
 <div id="main">
  <div class="mainleft">
   ...
   <c:if test="${readerId=='root' }">
	    <li><a href="/BookSystem/library/list.do" >借书信息</a></li>
	    <li><a href="/BookSystem/readerinfo/list.do">读者信息 </a></li>
	    <li><a href="/BookSystem/bookinfo/list.do" class="hover">书籍信息 </a></li>
	    <li><a href="/BookSystem/booktype/list.do">图书分类</a></li>
	    <li><a href="/BookSystem/bookcase/list.do">书架信息</a></li>
	    <li><a href="/BookSystem/readertype/list.do">读者分类 </a></li>
	    <li><a href="/BookSystem/manager/list.do">管理信息 </a></li>
	     <li><a href="/BookSystem/infopublish/list.do" >信息发布</a></li>
   </c:if> --%>
   </ul>
  </div>
  <div class="mainright">
   <div class="content">
   	<div style="margin-top:15px; text-align:center;">
   		<form action="/BookSystem/bookinfo/chaxunlist.do" method="post" id ="queryform">
	   		...
	   		<span >
	   			<input type="text" id = "content" name = "content" value ="${content }" placeholder="请输入书号"/>
   ...
   <!--  <h3>123<sub>JOINS US</sub></h3> -->
	...
	<div style="margin-top:10px; text-align:center;">
   		<table class="table table-hover table-bordered MT10" border="1" >
					<tr>
						<th width="115px;">书号</th>
						<th width="121px;">书名</th>
						<th width="115px;">位置</th>
						<th width="105px;">分类</th>
						<th width="105px;">书总量</th>
						<th width="105px;">现有量</th>
						<th width="106px;">价格</th>
						<c:if test="${readerId=='root' }">
							<th width="95px;">操作</th>
						</c:if>
					</tr>
