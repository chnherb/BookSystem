...
function modity(id){
	...
	var action = "/BookSystem/library/xujie.do";
	var params = "id="+id+"&readerno="+readerno;
...
<body>
 ...
 <div id="main">
  <div class="mainleft">
   <ul>
    <li><a href="/BookSystem/readerquery/list.do?readerno=${readerno}" class="hover">借阅历史</a></li>
  ...
  <div class="mainright">
   <div class="content">
   	<div style="margin-top:15px; text-align:center;">
   		<form action="/BookSystem/readerquery/list.do" method="post" id ="queryform">
   			<input type="hidden" id = "readerno" name ="readerno" value="${readerno}"/>
						...
						<c:forEach items="${pageData.list}" var="item" varStatus="vs">
							<tr>
								...
								<td style="text-align:center;">
									<input type="button" id = "modity" name = "modity" onclick = "modity('${item.id}');" value="续借"></a>
