...
function deletedata(id){
	var action = "/BookSystem/manager/delete.do";
	params = "id="+id;
...
$(function(){
 ...
 //修改
function toSave(id) {
	var url = "/BookSystem/manager/add.do";
	if(id!=''){
		url = "/BookSystem/manager/add.do?id="+id;
	}
	seajs.config({
		  alias: {
 ...
 <div id="main">
  <div class="mainleft">
   <ul>
    ...
    <li><a href="/BookSystem/manager/list.do" class="hover">权限管理 </a></li>
  ...
  <div class="mainright">
   <div class="content">
   	<div style="margin-top:15px; text-align:center;">
   		<form action="/BookSystem/manager/list.do" method="post" id ="queryform">
   ...
   <!--  <h3>123<sub>JOINS US</sub></h3> -->
	...
	<div style="margin-top:10px; text-align:center;">
   		<table class="table table-hover table-bordered MT10" border="1" >
					<tr>
						<th width="95px;">序号</th>
						<th width="110px;">账户</th>
						<th width="110px;">密码</th>
						<th width="455px;">备注</th>
					...
					<c:if test="${pageData.list.size() > 0}">
						<c:forEach items="${pageData.list}" var="item" varStatus="vs">
							<tr>
								...
								<td id="pwd" style="text-align:center;"><c:out value="${item.pwd}" /></td>
