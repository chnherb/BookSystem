...
function deletedata(id){
	var action = "/BookSystem/readertype/delete.do";
	params = "id="+id;
...
$(function(){
 ...
 //修改
function toSave(id) {
	var url = "/BookSystem/readertype/add.do";
	if(id!=''){
		url = "/BookSystem/readertype/add.do?id="+id;
	}
	seajs.config({
		  alias: {
 ...
 <div id="main">
  <div class="mainleft">
   <ul>
    ...
    <li><a href="/BookSystem/readertype/list.do" class="hover">读者类别</a></li>
  ...
  <div class="mainright">
   <div class="content">
   	<div style="margin-top:15px; text-align:center;">
   		<form action="/BookSystem/readertype/list.do" method="post" id ="queryform">
					...
					<c:if test="${pageData.list.size() > 0}">
						<c:forEach items="${pageData.list}" var="item" varStatus="vs">
							<tr>
								...
								<td id="typeName" style="text-align:center;"><c:out value="${item.typeName}" /></td>
