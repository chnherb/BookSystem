...
$().ready(function() {
 $("#editForm").validate();
  ...
  <body>
    <form action = "/BookSystem/readertype/save.do" method="post" id="editForm">
    	<table border="1px" style="text-align:center;">
    		<input type ="hidden" name = "id" id="id" value="${readerType.id }"/>
    		<tr>
    			<td style="width:100px">类名</td>
    			<td><input type="text" name ="typeName" id ="typeName" value ="${readerType.typeName }" class="{required:true,minlength:5}"/></td>
    		</tr>
    		<tr>
    			<td>备注</td>
    			<td><input type="text" name ="comment" id ="comment" value="${readerType.comment }" class="{required:true,minlength:5}"/></td>
    		</tr>
    	</table>
    </form>
  </body>
